...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_swiper__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__libs_fittext__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__libs_fittext___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__libs_fittext__);
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var dataToggleNavigation = Array.prototype.slice.call(document.querySelectorAll('[data-toggle="navigation"]'), 0);
  var oSite = document.getElementById('js-site');

  if (dataToggleNavigation.length > 0) {
    dataToggleNavigation.forEach(function (el) {
  ...
  var siteHeader = document.getElementById('js-header');
  ...
  var featureIntroSwiper = new __WEBPACK_IMPORTED_MODULE_0_swiper__["a" /* default */]('.c-feature--intro', {
    speed: 600,
    parallax: true,
    pagination: {
